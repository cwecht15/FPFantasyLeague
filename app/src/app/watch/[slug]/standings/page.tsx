/**
 * Spectator standings — identical to the league page (manager names included,
 * per the owner) minus the YOU personalization.
 */
...
export default async function WatchStandingsPage({
  params,
}: {
  ...
  const playoffCfg = playoffConfigSchema.safeParse((await getSettings(league.id)).playoffConfig);
